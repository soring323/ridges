...
VALIDATOR_HEARTBEAT_TIMEOUT_LOOP_INTERVAL_SECONDS = int(os.getenv("VALIDATOR_HEARTBEAT_TIMEOUT_LOOP_INTERVAL_SECONDS"))
if not VALIDATOR_HEARTBEAT_TIMEOUT_LOOP_INTERVAL_SECONDS:
    logger.fatal("VALIDATOR_HEARTBEAT_TIMEOUT_LOOP_INTERVAL_SECONDS is not set in .env")

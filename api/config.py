...
VALIDATOR_RUNNING_AGENT_TIMEOUT_SECONDS = int(os.getenv("VALIDATOR_RUNNING_AGENT_TIMEOUT_SECONDS"))
if not VALIDATOR_RUNNING_AGENT_TIMEOUT_SECONDS:
    logger.fatal("VALIDATOR_RUNNING_AGENT_TIMEOUT_SECONDS is not set in .env")

VALIDATOR_RUNNING_EVAL_TIMEOUT_SECONDS = int(os.getenv("VALIDATOR_RUNNING_EVAL_TIMEOUT_SECONDS"))

...
from queries.evaluation_run_logs import get_evaluation_run_logs_by_id

class EvaluationRunLogsResponse(BaseModel):
    logs: str
...
async def evaluation_run_get_logs_by_id(evaluation_run_id: UUID, type: EvaluationRunLogType) -> EvaluationRunLogsResponse:
    ...
    return EvaluationRunLogsResponse(logs=logs)

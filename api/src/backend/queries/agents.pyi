...
async def get_agent_by_agent_id(agent_id: str) -> Optional[MinerAgent]: ...
async def get_agent_approved_banned(agent_id: str, miner_hotkey: str) -> Tuple[Optional[datetime], bool]: ...
...
async def get_ban_reason(miner_hotkey: str) -> Optional[str]:
async def ban_agents(miner_hotkeys: List[str], reason: str) -> None: ...
async def approve_agent_version(agent_id: str) -> None: ...

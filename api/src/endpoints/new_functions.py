...
async def _get_next_evaluation_id_for_screener(screener_hotkey: str) -> Optional[uuid.UUID]:
...
async def _get_next_evaluation_id_for_validator(validator_hotkey: str) -> Optional[uuid.UUID]:
    # TODO
    pass
...
async def get_next_evaluation_id_for_validator_hotkey(validator_hotkey: str) -> Optional[uuid.UUID]:

...
# NOT USED ANYWHERE - FRONTEND OLD ENDPOINTS OR BACKEND
# @db_operation
...
# NEXT THREE FUNCTIONS & ENDPOINTS USED IN FRONTEND OLD ENDPOINTS
# @db_operation
...
# NEXT FUNCTION & ENDPOINTS USED IN FRONTEND OLD ENDPOINTS
# @db_operation
